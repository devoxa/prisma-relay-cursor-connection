...
export const PROFILE_FIXTURES: ProfileCreateInput[] = [
  ...
  { firstname: 'foo10', lastname: 'bar2' },
  { firstname: 'foo10', lastname: 'bar3' },
  { firstname: 'foo10', lastname: 'bar4' },
  { firstname: 'foo10', lastname: 'bar5' },
  { firstname: 'foo10', lastname: 'bar6' },
  { firstname: 'foo10', lastname: 'bar7' },
  { firstname: 'foo10', lastname: 'bar8' },
  { firstname: 'foo10', lastname: 'bar9' },
  { firstname: 'foo10', lastname: 'bar10' },
]
